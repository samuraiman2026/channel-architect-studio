...
@Index({
  name: "channel_architect_program_scope_idx",
  properties: ["tenantId", "organizationId", "updatedAt"],
})
...
@Index({
  name: "channel_architect_version_scope_idx",
  properties: ["tenantId", "organizationId", "programId"],
})
@Unique({
  name: "channel_architect_program_version_number_uq",
  properties: ["programId", "versionNumber"],
})
...
@Index({
  name: "channel_architect_review_scope_idx",
  properties: ["tenantId", "organizationId", "programVersionId"],
})
...
@Index({
  name: "channel_architect_pilot_scope_idx",
  properties: ["tenantId", "organizationId", "updatedAt"],
})
...
@Index({
  name: "channel_architect_checkpoint_scope_idx",
  properties: ["tenantId", "organizationId", "pilotId"],
})
