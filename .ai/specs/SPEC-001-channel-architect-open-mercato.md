...
7. Approving the current version activates a draft program. Archiving a program preserves its versions and decisions while preventing new pilots.
...
- Approving the current version activates its program, while archiving preserves history and prevents new pilots.
